...
if (isset($_POST['submit'])) 
{
 ...
 $query ="UPDATE `service` SET `name`=' $name',`email`='$email',`phone`='$phone',`carno`='$carno',`address`='$address',`city`='$city',`state`='$state',`pincode`='$pincode',`date`=' $date',`time`='$time'  WHERE id='$id'";
...
<div class="container">
  <form  method="POST">
    ...
    <input type="text" name="carno" placeholder="GJ-##-##-####" required  value="<?php echo $data['carno'];?>">
    <br></br>
