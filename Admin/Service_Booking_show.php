...
<head>
	...
	<title>Service Booking Show</title>
  <style type="text/css">
body{
  text-align: center;
}
...
<body>
 <h2 class="text-center pt-5">Service Booking Show</h2>
 ...
 <table class="center" style="width: 1000px" border="1px solid black">
  ...
  <tbody>
    <?php
    include("connect.php");
    $temp=mysqli_query($con,"SELECT * FROM `service`");
    while($data=mysqli_fetch_array($temp))
    {
      ...
      <tr>
       ...
       <td scope="col"><?php echo $data['carno']; ?></td>
       ...
       <td><a href="Service_Booking_update.php?id=<?php echo $data['id']; ?>"
        class="button">Update</a></td>
        <td><a href="Service_Booking_delete.php?uidi=<?php echo $data['id']; ?>" 
  ...
  <button class="ab"><a href="Service_Booking_insert.php" class="abc">Service Booking DETAIL</a></button>
 <br> <br>
</body>
</html>